...
namespace ejercicio01_corte1
{
	class Program
	{
		...
		{
			Console.WriteLine("Ejercicio práctico 01 del corte 1.");
			
			Console.WriteLine(" ");
			
			Console.WriteLine("Para éste ejercicio se debe mostrar tres números formados por tres variables numéricas en diferentes combinaciones.  ");
